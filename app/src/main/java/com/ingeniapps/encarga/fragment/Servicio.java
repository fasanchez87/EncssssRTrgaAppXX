...
public class Servicio extends Fragment implements OnMapReadyCallback,
        ...
        GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMyLocationButtonClickListener
{
   ...
   // ArrayList<PuntoConvenio> listadoPuntosConvenio;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        MapsInitializer.initialize(Servicio.this.getActivity());
    ...
    {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(new ContextThemeWrapper(Servicio.this.getActivity(), R.style.AlertDialogTheme));
        builder
                ...
                .rationale(new RationaleListener()
                {
                    ...
                    public void showRequestPermissionRationale(int requestCode, final Rationale rationale)
                    {
                        ...
                        builder
                                ...
                                .setMessage("Para pedir un servicio, es necesario que apruebes el permiso de ubicación, para ello presiona el botón Aceptar.")
    ...
    private PermissionListener permissionListener = new PermissionListener()
    {
        ...
        public void onFailed(int requestCode, @NonNull List<String> deniedPermissions)
        {
            ...
            if (AndPermission.hasAlwaysDeniedPermission(Servicio.this.getActivity(), deniedPermissions))
            {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(new ContextThemeWrapper(Servicio.this.getActivity(),R.style.AlertDialogTheme));
                builder
                        .setTitle("Permiso de Geolocalización")
                        ...
                        .setPositiveButton("PERMITIR", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int id)
                            {
                                SettingService settingService = AndPermission.defineSettingDialog(Servicio.this.getActivity(), REQUEST_CODE_SETTING);
    ...
    {
        if (ContextCompat.checkSelfPermission(Servicio.this.getActivity(), Manifest.permission.ACCESS_FINE_LOCATION)
    ...
    {
        if (ActivityCompat.checkSelfPermission(Servicio.this.getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) !=
                PackageManager.PERMISSION_GRANTED)
        {
            return;
        }
